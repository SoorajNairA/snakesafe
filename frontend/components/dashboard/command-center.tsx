...
export function CommandCenter() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 pb-16 pt-20">
      <div className="mb-8">
        ...
        {sections.map(({ key, label, description, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative min-w-[108px] aspect-square rounded-2xl border text-left px-4 py-3 transition-all",
                isActive
                  ? "border-primary bg-primary/10 shadow-[0_10px_30px_oklch(0_0_0/0.25)]"
